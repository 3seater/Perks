  ...
  return <footer className="site-footer">
    <div className="site-footer-main">
      ...
      <div className="site-footer-links">
        ...
        <section><h2>Connect</h2><a href="https://x.com/perkspad" target="_blank" rel="noreferrer">X / Twitter <ArrowUpRight size={13}/></a><a href="https://pump.fun/coin/A2v8cWqULudsrYcZXBCZcyKF5VGtKgc3a6a5DdJxpump" target="_blank" rel="noreferrer">pump.fun <ArrowUpRight size={13}/></a><Link href="/docs#support">Support</Link></section>
    ...
    <div className="site-footer-bottom"><span>© {year} Perks</span><span>Built on <b>Solana</b></span><span className="site-footer-launch">$PERKS CA: <span className="site-footer-contract">A2v8cWqULudsrYcZXBCZcyKF5VGtKgc3a6a5DdJxpump</span></span></div>
  </footer>;
}
